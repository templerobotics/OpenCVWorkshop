...
#Paths to resources
loadpath = os.path.join('ColorHighlightResources', 'zoeynjoe.jpg')
savepath = os.path.join('ColorHighlightResources', 'zoeynjoe_grayblue.jpg')

#Define the range of HSV values to isolate / detect
lower_blue = np.array([105, 150, 50], dtype = np.uint8)
